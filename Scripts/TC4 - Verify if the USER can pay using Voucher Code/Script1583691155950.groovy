...
driver.findElement(By.id("booking_voucher_voucher")).sendKeys("INV5")

driver.findElement(By.id("voucher-toggle")).click()
...
WebUI.click(findTestObject('Checkout Page/payAtHotel_label'))

driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS)

//verify if the user is redirected to checkout confirmation page

WebUI.verifyElementVisible(findTestObject('Checkout Confirmation Page/cancelOrder_button'))
